...
const CredentialInputFields:React.FC<CredentialInputFieldsProps> = ({setSingupValues,setUserCredential}) => {
  ...
  return (
    ...
    <input name="username" type="text" className="username-field" onChange={(e) => {
            handleCredential(e);
          }} />
  </div>
  {setUserCredential === undefined && (<div>
    <label>Email</label>
    <input name="email" type="text" className="email-field" onChange={(e) => {
            handleCredential(e);
          }} />
  </div>)}
  <div>
    <label>Password</label>
    <input name="password" type="password" className="passsword-field" onChange={(e) => {
            handleCredential(e);
          }} />
  </div></>
  )
